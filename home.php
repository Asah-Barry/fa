...
<body >
  <style>
    body {
      background-image:url("pharmaceutical-industry.jpg");
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
      ...
      <div class=" navbar-inner">
        ...
        <span class="icon-bar"></span>
          ...
          <a class="brand" href="#"><b>Pharma Management System Asahtech</b></a>
        ...
        $select_sql = "SELECT  * FROM stock WHERE expire_date <= '$inc_date' and status='Available' ";
         ...
         <li><a href="product/view.php?invoice_number=<?php echo $_GET['invoice_number']?>"><span class="icon-th"></span> Medicines</a></li>
        ...
        <font>Today's Sales:</font>
                  <strong><?php
                    ...
                    while($row = mysqli_fetch_array($select_query)){
                               ...
                               echo $row['sum(total_amount)']. ' FCFA';
   ...
   <div class="container">
     <div class="row">
      <div class="contentheader">
        <h2>Pharmacy- Manage Sales</h2>
       </div> <hr>
     
    <center>
      <div class="col-md-12">
        <form method="POST" action="insert_invoice.php?invoice_number=<?php echo $_GET['invoice_number']?> " >
        <input type="text" name="bar_code" id="bar_code" autocomplete="off" placeholder="Enter Barcode" style="width:300px;height: 30px;">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="alert alert-danger">
        <h3><center>Please Enter Medicine for sales!!</center> </h3>
    </div>
