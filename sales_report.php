...
<body   body {
      background-image:url("c:\xampp\htdocs\Asah Pharmacy-PHP\images\pharmaceutical-industry.jpg");
  ...
  <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
      <div class="navbar-inner">
        ...
        <li><a href="home.php?invoice_number=<?php echo $_GET['invoice_number']?>"><span class="icon-home"></span>Pharmacy sales</a></li>
            ...
            <th colspan="4">Total:</th>
                ...
                <th colspan="2">
                  ...
                  while($row = mysqli_fetch_array($select_query)){
                     ...
                     echo $row['sum(total_profit)']. ' FCFA';
                }
                  ?>
                            <?php }else{
